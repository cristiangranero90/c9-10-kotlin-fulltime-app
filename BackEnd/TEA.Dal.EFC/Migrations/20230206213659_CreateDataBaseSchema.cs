    ...
    public partial class CreateDataBaseSchema : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PostGallery", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PostGallery_Post_PostId",
                        column: x => x.PostId,
                        principalTable: "Post",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ComentId = table.Column<int>(type: "int", nullable: true),
                    CreateDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reaction_Coment_ComentId",
                        column: x => x.ComentId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PostGallery_PostId",
                table: "PostGallery",
                column: "PostId");

            migrationBuilder.CreateIndex(
                name: "IX_Reaction_ComentId",
                table: "Reaction",
                column: "ComentId");
